...
Во второй строке записаны N натуральных чисел Ai (Ai ≤ 200) – рост учеников в сантиметрах в порядке невозрастания. Третья строка содержит единственное натуральное число X (X ≤ 200) – рост Пети.
...
list = []
for i in range(num):
    list.append(int(input("Введите рост учеников: ")))
list = sorted(list, reverse = True)

print()
height = int(input("Какой у Пети рост: "))
print()
position = len(list) + 1
...
print(f"В шеренге Петин номер {position}")
